    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                ...
                action="{{route('store.info',$user->id)}}">
                    @csrf
					<span class="login100-form-title p-b-49">
						Complete Registrartion
					</span>
                    ...
                    <!-- City -->
                    <div class="wrap-input100 validate-input m-b-23" data-validate="City name is reauired">
                    ...
                    <div class="wrap-input100 validate-input m-b-23" data-validate="Phone number is reauired">
                        ...
                        <input class="input100" type="number" name="mobile" placeholder="phone number">
                        @error('mobile')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
