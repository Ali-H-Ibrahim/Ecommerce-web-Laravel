                                        ...
                                        @foreach($subCategories as $subCat)
                                            <li>
                                                <div class="form-check">
                                                    <input type="checkbox" class="filter_all" id="subcategory" value="{{$subCat->id}}">
                                ...
                                <ul>
                                    @if(isset($brands)&&$brands->count()>0)
                                        @foreach($brands as $brand)
                                            <li>
                                                <div class="form-check">
                                                    <input type="checkbox" class="filter_all" id="brand" value="{{$brand->id}}">
    ...
    <script type = "text/javascript">
        $(document).ready(function(){
            ...
            function filter_data(sortBy) {
                ...
                var category = <?php echo json_encode($category -> id); ?>;
                var subcategory = getMyFilter('subcategory');
